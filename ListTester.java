...
public class ListTester {
	...
	private void runTests() {
		...
		testSingleElementList(emptyList_add0A_A, "emptyList_add0,A_A", LIST_A, STRING_A);
		...
		testTwoElementList(A_addToFrontB_BA, "A_addToFrontB_BA", LIST_BA, STRING_BA);
			// added
		// does the LIST_BA and STRING_BA need to be changed - I think so tests failed without change
...
//			break;
	...
	/** Scenario: [A] -> removeFirst() -> emptyList
	 * 
	 * @return emptyList after removeFirst()
	 */
	...
	/** Scenario: [A] -> removeLast() -> emptyList
	 * 
	 * @return emptyList after removeLast()
	 */
	...
	/** Scenario: [A] -> remove(A) -> emptyList
	 * 
	 * @return emptyList after remove(A)
	 */
	...
	/** Scenario: [A] -> remove(0) -> emptyList
	 * 
	 * @return emptyList after remove(0)
	 */
	...
	private void testTwoElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			printTest(scenarioName + "_testRemoveEl0" + contentsString.charAt(0), testRemoveElement(scenario.build(), contents[0], Result.MatchingValue));
			printTest(scenarioName + "_testRemoveEl1" + contentsString.charAt(1), testRemoveElement(scenario.build(), contents[1], Result.MatchingValue));
			printTest(scenarioName + "_testRemoveX", testRemoveElement(scenario.build(), ELEMENT_X, Result.NoSuchElement));
			printTest(scenarioName + "_testFirst", testFirst(scenario.build(), contents[0], Result.MatchingValue));
